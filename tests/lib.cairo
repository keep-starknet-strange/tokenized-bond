...
use tokenized_bond::{TokenizedBond, ITokenizedBondDispatcher, ITokenizedBondDispatcherTrait, TokenizedBond::InternalImpl};
...
fn test_internal () {
    ...
    assert(state.inter_transfer_allowed(TOKEN_ID(), MINTER(), OWNER()), 'BOO');
